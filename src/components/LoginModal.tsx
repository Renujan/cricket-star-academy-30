...
const LoginModal = ({ children }: LoginModalProps) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md p-0 bg-gradient-to-b from-blue-600 to-blue-800 border-none">
        <div className="p-8 text-white">
          {/* Header */}
          <div className="flex items-center justify-center mb-8 relative">
            <ArrowLeft className="w-6 h-6 absolute left-0 cursor-pointer hover:opacity-80" />
          ...
          <div className="space-y-6">
            ...
            {/* Social Login */}
            <div className="text-center">
              <p className="text-white/80 mb-4">Or Log In With</p>
              <div className="flex justify-center space-x-4">
                ...
                <button
                  ...
                  className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center hover:scale-105 transition-transform"
                >
